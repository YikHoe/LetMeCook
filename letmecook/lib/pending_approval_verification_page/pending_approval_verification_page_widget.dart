...
import 'pending_approval_verification_page_model.dart';
export 'pending_approval_verification_page_model.dart';
import 'package:image_picker/image_picker.dart';
import 'dart:io';
import 'package:flutter/foundation.dart' show kIsWeb;

class PendingApprovalVerificationPageWidget extends StatefulWidget {
  const PendingApprovalVerificationPageWidget({super.key});

  @override
  State<PendingApprovalVerificationPageWidget> createState() =>
      _PendingApprovalRecipePageWidgetState();
}

class _PendingApprovalRecipePageWidgetState
    extends State<PendingApprovalVerificationPageWidget> {
  final RecipeRepository _recipeRepository = RecipeRepository();
  late Future<List<Recipe>> _pendingRecipes;
  late PendingApprovalVerificationPageModel _model;

  @override
  void initState() {
    super.initState();
    _model = createModel(context, () => PendingApprovalVerificationPageModel());
